...
1. **文件缺失处理**: 当 SPIRIT.md、OWNER.md 等核心文件不存在时，Agent 应如何处理？
...
- **FR-006**: Agent 必须定期执行记忆维护，将每日笔记提炼到 MEMORY.md
...
- **SC-004**: AGENTS.md 更新后，Agent 在下次提问时 100% 使用新版本
