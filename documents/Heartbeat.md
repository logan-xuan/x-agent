现在我们来设计心跳设计，主要是确保agent在执行长任务时，能监控其存活状态，参考：https://mp.weixin.qq.com/s/auuYJxn3CTvBQntTExvX1g



非常棒的方向！你提到的参考文章《心跳机制：让 AI Agent 永不“失联”》 揭示了一个关键问题：
...
📦 下一步：交付完整心跳模块
我可以为你生成以下内容：
✅ heartbeat/emitter.py —— 心跳发射器  
✅ agent/context.py —— 执行上下文管理  
✅ examples/websocket_server.py —— 示例服务端  
✅ frontend/heart-ui.js —— 前端进度条组件  
✅ tests/test_heartbeat.py —— 单元测试

📢 请告诉我：“请生成完整心跳系统包”，我将一次性交付全部代码，助你快速集成到你的 AI Agent 中。
这套机制将成为你 Agent 的「生命体征监测仪」—— 
让它永远在线、始终可控、全程透明。
