/** Middleware node component for trace visualization */

import { memo } from 'react';
import { Handle, Position, type NodeProps } from 'reactflow';
import type { FlowNodeData } from '@/types';

/** Middleware node for middleware events */
function MiddlewareNode({ data }: NodeProps<FlowNodeData>) {
  return (
    <div className="px-4 py-2 shadow-md rounded-md bg-cyan-50 border-2 border-cyan-400 min-w-[180px]">
