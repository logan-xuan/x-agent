...
class AgentCoreConfig:
    ...
    def with_system_prompt_port(self, system_prompt_port: SystemPromptPort) -> AgentCoreConfig:
        """设置系统提示词端口.
    ...
    def add_message_middleware(self, middleware: MessageMiddleware) -> AgentCoreConfig:
        """添加消息处理中间件.
    ...
    def add_tool_middleware(self, middleware: ToolMiddleware) -> AgentCoreConfig:
        """添加工具执行中间件.
