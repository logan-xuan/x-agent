...
async def get_schedule(schedule_id: str):
    ...
    try:
        ...
        raise HTTPException(status_code=404, detail={"trace_id": trace_id, "error": "Schedule not found"})
    except HTTPException:
        raise
    except Exception as e:
        logger.error("Failed to get schedule", extra={"trace_id": trace_id, "error": str(e)})
        raise HTTPException(status_code=500, detail={"trace_id": trace_id, "error": str(e)})
...
async def get_schedule_by_id(schedule_id: str):
    ...
    try:
        ...
        logger.error("Failed to get schedule", extra={"schedule_id": schedule_id, "error": str(e)})
...
async def run_task_now(
    ...
    try:
        ...
        logger.error("run_task_now failed", extra={"task_id": task_id, "error": str(e), "error_type": type(e).__name__})
        raise HTTPException(status_code=400, detail=str(e))
