...
class ToolParameter:
    ...
    def to_json_schema(self) -> dict:
        ...
        if self.type == ToolParameterType.ARRAY and self.items_schema is not None:
    ...
    def validate(self, value: Any) -> tuple[bool, str | None]:
        ...
        if self.type in (ToolParameterType.NUMBER, ToolParameterType.INTEGER) and isinstance(
            value, (int, float)
        ):
