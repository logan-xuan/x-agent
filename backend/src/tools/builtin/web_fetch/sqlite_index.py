...
class SQLiteIndexManager:
    ...
    def __init__(self, db_path: str | None = None):
        ...
        logger.info("SQLiteIndexManager initialized", extra={"db_path": db_path})
    ...
    async def get_index(self, url: str) -> dict | None:
        ...
        try:
            with sqlite3.connect(self.db_path) as conn:
                ...
                return {
                    ...
                    "entries_by_date": [{"date": row[0], "count": row[1]} for row in date_counts],
                }
