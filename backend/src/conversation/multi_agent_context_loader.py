...
class MultiAgentContextLoader:
    ...
    def _resolve_workspace_path(self, agent_config: AgentConfig) -> Path:
        ...
        if agent_config.workspace:
            # Use agent-specific workspace
            workspace = agent_config.workspace
        else:
            # Fallback to default workspace (should not happen in multi-agent setup)
            workspace = "workspace"
    ...
    def get_agent_context(self, agent_id: str) -> Optional[AgentContextInfo]:
    ...
    def get_context_loader(self, agent_id: str) -> Optional[ContextLoader]:
    ...
    def reload_agent_context(self, agent_id: str) -> Optional[Dict[str, bool]]:
