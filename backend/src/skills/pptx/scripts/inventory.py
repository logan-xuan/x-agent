...
class ParagraphData:
    ...
    def __init__(self, paragraph: Any):
        ...
        if hasattr(paragraph, "_p") and paragraph._p is not None and paragraph._p.pPr is not None:
            ...
            if p_pr.find(f"{ns}buChar") is not None or p_pr.find(f"{ns}buAutoNum") is not None:
                self.bullet = True
...
class ShapeData:
    ...
    def __init__(
        ...
        if (
            ...
            and shape.is_placeholder  # type: ignore
            and shape.placeholder_format
            and shape.placeholder_format.type  # type: ignore
        ):
