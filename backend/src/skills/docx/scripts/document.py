...
class DocxXMLEditor(XMLEditor):
    ...
    def suggest_paragraph(xml_content: str) -> str:
        ...
        if not p_pr_list:
            ...
            para.insertBefore(p_pr, para.firstChild) if para.firstChild else para.appendChild(p_pr)
        else:
            p_pr = p_pr_list[0]
        ...
        r_pr.insertBefore(ins_marker, r_pr.firstChild) if r_pr.firstChild else r_pr.appendChild(
            ins_marker
        )
    ...
    def suggest_deletion(self, elem):
        ...
        if elem.nodeName == "w:r":
            ...
            if is_numbered:
                ...
                r_pr.insertBefore(del_marker, r_pr.firstChild) if r_pr.firstChild else r_pr.appendChild(
                    del_marker
                )
